...
hosts, tests, and generated DCB templates; the applicable `Microsoft.Extensions.*` floor is **10.0.5** and
Polly remains a normal transitive dependency. Upgrade all cluster nodes together. A mixed 10.0.1/10.3.1
