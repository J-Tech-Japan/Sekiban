...
{
    public static BaseFirstAggregate OnEvent(BaseFirstAggregate aggregatePayload, Event<BFAggregateInitiated> ev) =>
        new() { Name = ev.Payload.Name, Price = ev.Payload.Price };
}
