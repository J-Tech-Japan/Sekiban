...
public class DebugDatabaseContentTest : PostgresTestBase
{
    ...
    public async Task Debug_Database_Content_After_Write()
    {
        ...
        {
            new Event(
                new StudentCreated(studentId, "Test Student", 5),
        ...
        {
            _output.WriteLine($"  Event: Id={dbEvent.Id}, Type={dbEvent.EventType}, SortableUniqueId={dbEvent.SortableUniqueId}, Tags={dbEvent.Tags}");
        }
        ...
        {
            _output.WriteLine($"  Tag: Id={dbTag.Id}, Tag={dbTag.Tag}, EventId={dbTag.EventId}, SortableUniqueId={dbTag.SortableUniqueId}");
        }
