...
public class GeneralMultiProjectionActorSafeWindowChaosTests
{
    ...
    public async Task SafeWindow_OutOfOrderEvents_CorrectlySortedInSafeState()
    {
        ...
        var event1 = CreateEvent(new TestEventCreated("Item 1"), now.AddSeconds(-3), Guid.Parse("00000000-0000-0000-0000-000000000001"));
        var event2 = CreateEvent(new TestEventCreated("Item 2"), now.AddSeconds(-2.5), Guid.Parse("00000000-0000-0000-0000-000000000002"));
        var event3 = CreateEvent(new TestEventCreated("Item 3"), now.AddSeconds(-2), Guid.Parse("00000000-0000-0000-0000-000000000003"));
    ...
    public async Task SafeWindow_ChaosScenario_EventuallyConsistent()
    {
        ...
        var events = new List<Event>
        {
            ...
            CreateEvent(new TestEventCreated("Recent 1"), now.AddSeconds(-3), Guid.Parse("10000000-0000-0000-0000-000000000001")),
            CreateEvent(new TestEventCreated("Recent 2"), now.AddSeconds(-2), Guid.Parse("20000000-0000-0000-0000-000000000002")),
            CreateEvent(new TestEventCreated("Recent 3"), now.AddSeconds(-1), Guid.Parse("30000000-0000-0000-0000-000000000003")),
        };
        
        // Duplicate event
        var duplicateEvent = CreateEvent(new TestEventCreated("Recent 2"), now.AddSeconds(-2), Guid.Parse("20000000-0000-0000-0000-000000000002"));
    ...
    public async Task SafeWindow_UpdateEvents_CorrectOrderingMaintained()
    {
        ...
        var createEvent = CreateEvent(new TestEventCreated("Original"), now.AddSeconds(-4), Guid.Parse("00000000-0000-0000-0000-000000000001"));
        var update1 = CreateEvent(new TestEventUpdated("Original", "Updated1"), now.AddSeconds(-3), Guid.Parse("00000000-0000-0000-0000-000000000002"));
        var update2 = CreateEvent(new TestEventUpdated("Updated1", "Updated2"), now.AddSeconds(-2), Guid.Parse("00000000-0000-0000-0000-000000000003"));
        var update3 = CreateEvent(new TestEventUpdated("Updated2", "Final"), now.AddSeconds(-1), Guid.Parse("00000000-0000-0000-0000-000000000004"));
