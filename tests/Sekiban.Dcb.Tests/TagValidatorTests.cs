...
public class TagValidatorTests
{
    ...
    public void ValidateTag_InvalidCharactersInGroup_ReturnsError(string tagString, TagValidationErrorType expectedError)
    {
        // Arrange
        var tag = new TestTag(tagString);
    ...
    [InlineData("Group:content!", TagValidationErrorType.InvalidCharactersInContent)]
    public void ValidateTag_InvalidCharactersInContent_ReturnsError(string tagString, TagValidationErrorType expectedError)
    {
        // Arrange
        var tag = new TestTag(tagString);
    ...
    public void ValidateTagAndThrow_InvalidTag_ThrowsException()
    {
        ...
        // Act & Assert
        var exception = Assert.Throws<TagValidationErrorsException>(() => 
            TagValidator.ValidateTagAndThrow(tag));
    ...
    private class TestTag : ITag
    {
        ...
        public TestTag(string tagString)
        {
