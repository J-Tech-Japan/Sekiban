...
public class EventOrNoneVersionTest
{
    ...
    public async Task EventOrNone_None_Should_Not_Increment_Version()
    {
        ...
        var initialAggregate = executor.Repository.Load(
            registerResult.PartitionKeys,
            new UserProjector()).UnwrapBox();
        ...
        var aggregateAfterNoOp = executor.Repository.Load(
            registerResult.PartitionKeys,
            new UserProjector()).UnwrapBox();
    ...
    public async Task EventOrNone_WithEvent_Should_Increment_Version()
    {
        ...
        var aggregateAfterUpdate = executor.Repository.Load(
            registerResult.PartitionKeys,
            new UserProjector()).UnwrapBox();
    ...
    public async Task Multiple_EventOrNone_None_Should_Not_Change_Version()
    {
        ...
        var aggregate = executor.Repository.Load(
            registerResult.PartitionKeys,
            new UserProjector()).UnwrapBox();
