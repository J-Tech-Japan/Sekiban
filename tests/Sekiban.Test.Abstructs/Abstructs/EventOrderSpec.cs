    ...
    : TestBase<FeatureCheckDependency>(sekibanTestFixture, output, providerGenerator)
{
    ...
    public async Task EventOrderTest()
    {
        ...
        var sortableUniqueIdLowerBound = eventsOldToNew.First().SortableUniqueId;
        var sortableUniqueIdUpperBound = eventsOldToNew.Last().SortableUniqueId;
        eventsOldToNew = [];
        await repository.GetEvents(
        ...
        sortableUniqueIdLowerBound = eventsOldToNew.First().SortableUniqueId;
        sortableUniqueIdUpperBound = eventsOldToNew.Last().SortableUniqueId;
        eventsOldToNew = [];
        await repository.GetEvents(
