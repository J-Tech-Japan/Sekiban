...
/// <summary>
///     Weather forecast projection state using SafeUnsafeProjectionStateV6
/// </summary>
public record WeatherForecastProjectionV6 : IMultiProjector<WeatherForecastProjectionV6>
{
    /// <summary>
    ...
    /// <summary>
    ///     Internal state managed by SafeUnsafeProjectionStateV6
    /// </summary>
    public SafeUnsafeProjectionStateV6<WeatherForecastItem> State { get; init; } = new();

    public static string MultiProjectorName => "WeatherForecastProjectionV6";

    public static WeatherForecastProjectionV6 GenerateInitialPayload() => new();
    ...
    /// </summary>
    public static ResultBox<WeatherForecastProjectionV6> Project(
        WeatherForecastProjectionV6 payload,
        Event ev,
        List<ITag> tags)
    {
        ...
        Func<Guid, WeatherForecastItem?, Event, WeatherForecastItem?> projectItem = (forecastId, current, evt) =>
        {
            ...
            if (tag == null)
            {
                return current; // No tag for this ID
            }
            ...
            return evt.Payload switch
            {
                ...
                _ => current // Unknown event type, no change
            };
        };
