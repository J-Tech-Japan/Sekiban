...
public class WeatherPage
{
    ...
    public WeatherPage(IPage page) => _page = page;
    ...
    public async Task NavigateToWeatherPage()
    {
        ...
        var weatherLink = _page.Locator("nav a.nav-link", new PageLocatorOptions { HasText = PageName });
    ...
    public async Task AddWeatherForecast(string location, string temperature, string summary)
    {
        ...
        var addButton = _page.GetByRole(
            AriaRole.Button,
            new PageGetByRoleOptions { Name = "Add New Weather Forecast" });
        ...
        catch (Exception ex)
        {
            ...
            try
            {
                ...
                await _page
                    .Locator("select[name='forecastModel.Summary']")
            ...
            catch (Exception ex2)
            {
                ...
                try
                {
                    ...
                    Console.WriteLine(
                        $"  [WeatherPage] Filled form using label selectors in {sw.ElapsedMilliseconds}ms");
                }
                catch (Exception ex3)
                {
        ...
        catch (Exception ex)
        {
            ...
            try
            {
                var addForecastButton = _page.GetByRole(
                    AriaRole.Button,
                    new PageGetByRoleOptions { Name = "Add Forecast" });
                await addForecastButton.ClickAsync();
            ...
            catch (Exception ex2)
            {
                ...
                var addForecastButton = _page.GetByText("Add Forecast", new PageGetByTextOptions { Exact = true });
                await addForecastButton.ClickAsync();
        ...
        catch (Exception ex)
        {
            ...
            try
            {
                ...
                Console.WriteLine(
                    $"  [WeatherPage] Modal closed after clicking close button in {sw.ElapsedMilliseconds}ms");
            }
            catch (Exception ex2)
            {
    ...
    public async Task EditWeatherForecast(int rowIndex, string newLocation, string newTemperature, string newSummary)
    {
        ...
        catch (Exception ex)
        {
            ...
            catch (Exception ex2)
            {
                ...
                catch (Exception ex3)
                {
                    ...
                    Console.WriteLine(
                        $"  [WeatherPage] Filled form using index selectors in {sw.ElapsedMilliseconds}ms");
                }
            }
        }
        ...
        try
        {
            ...
            Console.WriteLine(
                $"  [WeatherPage] Clicked Update Location button by selector in {sw.ElapsedMilliseconds}ms");
        }
        catch (Exception ex)
        {
            ...
            try
            {
                var updateButton = _page.GetByRole(
                    AriaRole.Button,
                    new PageGetByRoleOptions { Name = "Update Location" });
                await updateButton.ClickAsync();
                Console.WriteLine(
                    $"  [WeatherPage] Clicked Update Location button by role in {sw.ElapsedMilliseconds}ms");
            }
            catch (Exception ex2)
            {
                ...
                // Try by text as a last resort
                var updateButton = _page.GetByText("Update Location", new PageGetByTextOptions { Exact = true });
                await updateButton.ClickAsync();
                Console.WriteLine(
                    $"  [WeatherPage] Clicked Update Location button by text in {sw.ElapsedMilliseconds}ms");
            }
        }
        ...
        catch (Exception ex)
        {
            ...
            try
            {
                ...
                Console.WriteLine(
                    $"  [WeatherPage] Edit modal closed after clicking close button in {sw.ElapsedMilliseconds}ms");
            }
            catch (Exception ex2)
            {
    ...
    public async Task DeleteWeatherForecast(int rowIndex)
    {
        ...
        catch (Exception ex)
        {
            ...
            try
            {
                ...
                var deleteButton = row.GetByRole(AriaRole.Button, new LocatorGetByRoleOptions { Name = "Remove" });
        ...
        catch (Exception ex)
        {
            ...
            try
            {
                var confirmButton = _page.GetByRole(AriaRole.Button, new PageGetByRoleOptions { Name = "Confirm" });
                if (await confirmButton.CountAsync() > 0)
                {
                    await confirmButton.ClickAsync();
