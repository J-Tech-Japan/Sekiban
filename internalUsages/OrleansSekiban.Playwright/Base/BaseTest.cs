    ...
    public class BaseTest : IDisposable
    {
        ...
        public async Task SetUp()
        {
            ...
            try
            {
                ...
                {
                    throw new DirectoryNotFoundException("Could not find OrleansSekiban.AppHost directory in any of the expected locations");
                }
        ...
        private string FindAppHostDirectory(string startingDirectory)
        {
            ...
            {
                string appHostPath = Path.Combine(solutionRoot, "OrleansSekiban.AppHost");
            ...
            foreach (string relativePath in possiblePaths)
            {
                try
                {
                    ...
                    if (Directory.Exists(fullPath))
                    {
                        ...
                        string appHostSubdir = Path.Combine(fullPath, "OrleansSekiban.AppHost");
            ...
            try
            {
                ...
                {
                    string appHostPath = Path.Combine(projectRoot, "OrleansSekiban.AppHost");
                    if (Directory.Exists(appHostPath))
                    {
                        return appHostPath;
                    }
