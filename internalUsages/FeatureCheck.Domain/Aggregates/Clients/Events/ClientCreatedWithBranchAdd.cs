...
public record ClientCreatedWithBranchAdd(Guid BranchId, string ClientName, string ClientEmail) : IEventPayload<Client, ClientCreatedWithBranchAdd>
{
    public static Client OnEvent(Client aggregatePayload, Event<ClientCreatedWithBranchAdd> ev) =>
