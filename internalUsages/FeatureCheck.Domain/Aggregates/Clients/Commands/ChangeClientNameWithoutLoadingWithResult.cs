...
public record ChangeClientNameWithoutLoadingWithResult(Guid ClientId, string ClientName) : ICommandWithHandlerWithoutLoadingAggregate<Client,ChangeClientNameWithoutLoadingWithResult>
{
