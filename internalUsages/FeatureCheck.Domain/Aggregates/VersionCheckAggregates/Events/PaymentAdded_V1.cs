...
{
    public static VersionCheckAggregate OnEvent(VersionCheckAggregate aggregatePayload, Event<PaymentAdded_V1> ev) => throw new SekibanEventOutdatedException(typeof(PaymentAdded_V1));
