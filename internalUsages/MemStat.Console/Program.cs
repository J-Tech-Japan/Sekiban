...
;
Console.WriteLine($"Memory Used Mac :{new MemoryUsageFinder().GetMemoryUsagePercentage().UnwrapBox():P0}");
...
var vmStatLinux = LinuxMemoryInfo.Parse(linuxFree, DateTime.Now);
