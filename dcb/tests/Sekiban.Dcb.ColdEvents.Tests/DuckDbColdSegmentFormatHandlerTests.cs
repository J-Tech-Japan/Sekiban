...
public class DuckDbColdSegmentFormatHandlerTests
{
    ...
    [Fact]
    public async Task Should_write_and_read_duckdb_segment_with_same_handler()
    {
        var handler = new DuckDbColdSegmentFormatHandler();
        var events = new[]
        {
