...
public class NameValidatorTests
{
    ...
    {
        // Act & Assert
        var exception = Assert.Throws<ArgumentException>(() => NameValidator.ValidateProjectorNameAndThrow(null!));
    ...
    {
        // Act & Assert
        var exception = Assert.Throws<ArgumentException>(() => NameValidator.ValidateProjectorNameAndThrow(""));
        Assert.Contains("cannot be null or empty", exception.Message);
    }
    ...
    public void ValidateProjectorNameAndThrow_TooLongName_ThrowsArgumentException()
    {
        ...
        // Act & Assert
        var exception = Assert.Throws<ArgumentException>(() => NameValidator.ValidateProjectorNameAndThrow(longName));
    ...
    [InlineData("Invalid@Name", "invalid characters")]
    public void ValidateProjectorNameAndThrow_InvalidCharacters_ThrowsArgumentException(
        string name,
        string expectedMessage)
    {
        // Act & Assert
        var exception = Assert.Throws<ArgumentException>(() => NameValidator.ValidateProjectorNameAndThrow(name));
    ...
    {
        // Act & Assert
        var exception = Assert.Throws<ArgumentException>(() => NameValidator.ValidateTagGroupNameAndThrow(null!));
        Assert.Contains("cannot be null or empty", exception.Message);
    }
    ...
    {
        // Act & Assert
        var exception = Assert.Throws<ArgumentException>(() => NameValidator.ValidateTagGroupNameAndThrow(""));
        Assert.Contains("cannot be null or empty", exception.Message);
    }
    ...
    public void ValidateTagGroupNameAndThrow_TooLongName_ThrowsArgumentException()
    {
        ...
        // Act & Assert
        var exception = Assert.Throws<ArgumentException>(() => NameValidator.ValidateTagGroupNameAndThrow(longName));
        Assert.Contains("exceeds maximum length", exception.Message);
        Assert.Contains("40", exception.Message);
    }
    ...
    public void ValidateTagGroupNameAndThrow_InvalidCharacters_ThrowsArgumentException(
        string name,
        string expectedMessage)
    {
        // Act & Assert
        var exception = Assert.Throws<ArgumentException>(() => NameValidator.ValidateTagGroupNameAndThrow(name));
        Assert.Contains(expectedMessage, exception.Message, StringComparison.OrdinalIgnoreCase);
    }
    #endregion
    ...
    public void ProjectorName_And_TagGroupName_HaveDifferentRules()
    {
        ...
        Assert.Throws<ArgumentException>(() => NameValidator.ValidateProjectorNameAndThrow(nameWithNumbers));

        // Should succeed for tag group name
        var exception = Record.Exception(() => NameValidator.ValidateTagGroupNameAndThrow(nameWithNumbers));
        Assert.Null(exception);
    }
    #endregion
}
