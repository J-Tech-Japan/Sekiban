    ...
    where TTagProjector : ITagProjector<TTagProjector> where TTagGroup : IStringTagGroup<TTagGroup>
{
    ...
    public static GenericStringTagMultiProjector<TTagProjector, TTagGroup> Deserialize(DcbDomainTypes domainTypes, string safeWindowThreshold, ReadOnlySpan<byte> data)
    {
        ...
        return new GenericStringTagMultiProjector<TTagProjector, TTagGroup>
        {
            State = state,
        ...
        DcbDomainTypes domainTypes)
    {
        ...
        {
            State = SafeUnsafeProjectionState<string, TagState>.FromCurrentData(safeDict),
        ...
        return new SafeProjection<GenericStringTagMultiProjector<TTagProjector, TTagGroup>>(safePayload, safeLast, version);
    }
