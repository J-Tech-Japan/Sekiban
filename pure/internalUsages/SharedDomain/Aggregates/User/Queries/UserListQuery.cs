        ...
        IWaitForSortableUniqueId
{
        ...
        IQueryContext context)
    {
        return projection
            ...
            .Select(tuple => new UserRecord(tuple.PartitionKeys.AggregateId, tuple.Item1.Name, tuple.Item1.Email))
            .ToResultBox();
    }
    ...
    [GenerateSerializer]
    public record UserRecord(Guid UserId, string Name, string Email);
}
