...
public record SortableUniqueId(string Value)
{
    ...
    {
        return Value.Length >= TickNumberOfLength + IdNumberOfLength 
    ...
    /// </summary>
    public static SortableUniqueId MaxValue => Generate(DateTime.MaxValue, new Guid("FFFFFFFF-FFFF-FFFF-FFFF-FFFFFFFFFFFF"));
    ...
    public static OptionalValue<SortableUniqueId> OptionalValue(string? value) =>
        !string.IsNullOrWhiteSpace(value)
            ? new SortableUniqueId(value)
            : OptionalValue<SortableUniqueId>.Empty;
    ...
    public static ResultBox<SortableUniqueId> Parse(string value)
    {
        ...
        if (value.Length != TickNumberOfLength + IdNumberOfLength)
            return ResultBox.Error<SortableUniqueId>(new ArgumentException($"Value must be exactly {TickNumberOfLength + IdNumberOfLength} characters long"));
