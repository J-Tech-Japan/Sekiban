...
{
    public static SekibanSettings Default => new(new MemoryCacheSetting(), new List<SekibanContextSettings> { new(new AggregateSettingHelper()) });

    public static SekibanSettings FromConfiguration(IConfiguration configuration) => FromConfigurationSection(configuration.GetSection("Sekiban"));
    public static SekibanSettings FromConfigurationSection(IConfigurationSection section)
    {
        ...
        {
            contextSettings.Add(new SekibanContextSettings(AggregateSettingHelper.FromConfigurationSection(defaultContextSection)));
        }
