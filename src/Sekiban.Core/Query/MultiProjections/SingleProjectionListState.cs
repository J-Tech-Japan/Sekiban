...
public record
    SingleProjectionListState<TAggregateState> : IMultiProjectionPayloadGeneratePayload<
    SingleProjectionListState<TAggregateState>> where TAggregateState : IAggregateStateCommon
{
