    ...
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        ...
        context.RegisterSourceOutput(
            ...
            (ctx, source) =>
            {
                ...
                var sourceCode = GenerateSourceCode(eventTypes, aggregateTypes, rootNamespace);
                ctx.AddSource("EventTypes.g.cs", SourceText.From(sourceCode, Encoding.UTF8));
            });
    }
    
    private string GenerateSourceCode(ImmutableArray<SekibanTypesExtractors.EventTypeValues> eventTypes, ImmutableArray<SekibanTypesExtractors.AggregateTypesValues> aggregateTypes, string rootNamespace)
    {
