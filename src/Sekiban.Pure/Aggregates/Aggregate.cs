...
{
    public IAggregatePayload GetPayload() => Payload;
    public ResultBox<Aggregate<TAggregatePayload1>> ToTypedPayload<TAggregatePayload1>()
        where TAggregatePayload1 : IAggregatePayload => Payload is TAggregatePayload1 typedPayload
        ? ResultBox.FromValue(
            new Aggregate<TAggregatePayload1>(
                typedPayload,
                PartitionKeys,
                Version,
                LastSortableUniqueId,
