...
public interface
    ICommandWithHandlerAsync<TCommand, TProjector> : ICommandWithHandlerAsync<TCommand, TProjector, IAggregatePayload>,
...
public interface
    ...
    ICommandHandlerAsync<TCommand, TAggregatePayload>,
