...
public class SnapshotDocumentCache : ISnapshotDocumentCache
{
    ...
    public SnapshotDocument? Get(
        ...
        _memoryCache.Cache.Get<SnapshotDocument>(
            GetCacheKey(aggregateId, aggregatePayloadType, projectionPayloadType, rootPartitionKey));
    ...
    private MemoryCacheEntryOptions GetMemoryCacheOptions() =>
        ...
        {
            AbsoluteExpiration
                = DateTimeOffset.UtcNow.AddMinutes(_memoryCacheSettings.Snapshot.AbsoluteExpirationMinutes),
