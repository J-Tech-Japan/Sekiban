...
public class SingleProjectionQueryTest<TSingleProjectionPayload, TQuery,
    ...
    where TQueryParameter : IQueryParameter
{
    ...
    public SingleProjectionQueryTest<TSingleProjectionPayload
        , TQuery, TQueryParameter, TQueryResponse> WhenParam(TQueryParameter param)
    {
        ...
        Response = QueryService
            .GetSingleProjectionQueryAsync<TSingleProjectionPayload, TQuery, TQueryParameter, TQueryResponse>(
                param)
            .Result;
    ...
    public SingleProjectionQueryTest<TSingleProjectionPayload, TQuery,
