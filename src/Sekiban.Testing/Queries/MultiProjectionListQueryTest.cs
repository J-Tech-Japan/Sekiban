...
public class
    MultiProjectionListQueryTest<TProjectionPayload, TQuery, TQueryParameter, TQueryResponse> :
        IQueryTest
    ...
    where TQuery : IMultiProjectionListQuery<TProjectionPayload, TQueryParameter, TQueryResponse>
{
    ...
    public MultiProjectionListQueryTest<TProjectionPayload, TQuery, TQueryParameter, TQueryResponse>
        WhenParam(TQueryParameter param)
    {
        ...
        _response = QueryService
            .GetMultiProjectionListQueryAsync<TProjectionPayload, TQuery, TQueryParameter, TQueryResponse>(param)
            .Result;
        return this;
    }
    public MultiProjectionListQueryTest<TProjectionPayload, TQuery, TQueryParameter, TQueryResponse>
