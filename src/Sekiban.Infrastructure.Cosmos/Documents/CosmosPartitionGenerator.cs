...
public class CosmosPartitionGenerator
{
    public static PartitionKey ForEvent(string rootPartitionKey, Type aggregateType, Guid aggregateId) =>
        new PartitionKeyBuilder()
            ...
            .Build();
    public static PartitionKey ForEventGroup(string rootPartitionKey, string aggregateGroup, Guid aggregateId) =>
        new PartitionKeyBuilder()
            .Add(rootPartitionKey)
            .Add(aggregateGroup)
            .Add(PartitionKeyGenerator.ForEventGroup(aggregateId, aggregateGroup, rootPartitionKey))
            .Build();
    ...
    public static PartitionKey ForSingleProjectionSnapshot(
        ...
        new PartitionKeyBuilder()
            ...
            .Add(aggregateType.GetBaseAggregatePayloadTypeFromAggregate().Name)
            .Add(
                PartitionKeyGenerator.ForAggregateSnapshot(
                    aggregateId,
                    aggregateType,
                    projectionType,
                    rootPartitionKey))
