...
public class SekibanDcbDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<DbEvent>(entity =>
        {
            ...
            entity.HasIndex(e => e.SortableUniqueId)
                .IsUnique()
            ...
            entity.Property(e => e.SortableUniqueId)
                .IsRequired()
                .HasMaxLength(100);
        });
        ...
        modelBuilder.Entity<DbTag>(entity =>
        {
            ...
            entity.HasIndex(t => t.SortableUniqueId)
            ...
            entity.HasIndex(t => new { t.Tag, t.SortableUniqueId })
                .HasDatabaseName("IX_Tags_Tag_SortableUniqueId");
            
            // Ensure proper ordering
            entity.Property(t => t.SortableUniqueId)
                .IsRequired()
                .HasMaxLength(100);
        });
    }
