...
var domainTypes = DaprSekibanDomainDomainTypes.Generate(DaprSekibanDomainEventsJsonContext.Default.Options);
...
var maxConcurrency = builder.Configuration.GetValue<int>("EventRelay:MaxConcurrency", 10);
var continueOnFailure = builder.Configuration.GetValue<bool>("EventRelay:ContinueOnProjectorFailure", false);
