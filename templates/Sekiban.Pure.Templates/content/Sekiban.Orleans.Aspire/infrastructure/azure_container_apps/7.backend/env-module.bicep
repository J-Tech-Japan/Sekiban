...
var orleansClusteringConnectionStringName = orleansClusterType == 'cosmos' ? 'OrleansCosmos' : 'MyProjectClustering'
...
var orleansQueueConnectionStringName = orleansQueueType == 'eventhub' ? 'OrleansEventHub' : 'MyProjectQueue'
...
var envVars = concat([
  ...
  {
    name: 'ConnectionStrings__MyProjectGrainState'
