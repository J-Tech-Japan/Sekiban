...
public record DeactivateRoom : ICommandWithHandler<DeactivateRoom>
{
    [Required]
        ...
        ICommandContext context)
    {
        ...
        return new RoomDeactivated(command.RoomId, command.Reason, DateTime.UtcNow)
            .GetEventWithTags();
    }
}
