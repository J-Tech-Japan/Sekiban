...
public class GeneralQuerySampleSpec : UnifiedTest<FeatureCheckDependency>
{
    ...
    public void GeneralQueryBasicTest()
    {
        ...
        var clientId1 = RunCommand(new CreateClient(branchId, "Test Client1", "testclient1@example.com"));
        var clientId2 = RunCommand(new CreateClient(branchId, "Test Client2", "testclient2@example.com"));
        var clientId3 = RunCommand(new CreateClient(branchId, "Test Client3", "testclient3@example.co.jp"));
        var clientId4 = RunCommand(new CreateClient(branchId, "Test Client4", "testclient4@example.jp"));
