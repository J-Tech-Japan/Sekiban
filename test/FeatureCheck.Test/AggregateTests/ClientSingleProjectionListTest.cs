...
public class ClientSingleProjectionListTest : UnifiedTestBase<CustomerDependency>
{
    ...
    public void Test()
    {
        ...
        var client1Id = RunCreateCommand(new Client(branchId, "John Smith", "john@example.com"));
        ...
        var client2Id = RunCreateCommand(new Client(branchId, "test name", "test@example.com"));
